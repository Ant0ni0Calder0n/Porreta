import{g as y,e as I,f as g,h as C,F as D,i as O,C as _,k as N}from"./index-BGvUU35e.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H="auth-internal",J="app-check-internal",V="messaging-internal";function B(e,t){const n=(r,{instanceIdentifier:i})=>{const o=r.getProvider("app").getImmediate(),s=r.getProvider(H),a=r.getProvider(V),l=r.getProvider(J);return new R(o,s,a,l,i,e)};O(new _(m,n,"PUBLIC").setMultipleInstances(!0)),N(k,A,t),N(k,A,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(e=y(),t=p){const r=I(g(e),m).getImmediate({identifier:t}),i=C("functions");return i&&X(r,...i),r}function X(e,t,n){U(g(e),t,n)}function q(e,t,n){return x(g(e),t,n)}B(fetch.bind(self));export{X as connectFunctionsEmulator,K as getFunctions,q as httpsCallable};
